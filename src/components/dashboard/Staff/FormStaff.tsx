...
import { Button, Form, FormProps, Input, message, Radio } from "antd";
...
export default function FormStaff(props: Props) {
  ...
  const onFinish: FormProps<FieldType>["onFinish"] = async (value) => {
    try {
      ...
      console.error(error);
      messageApi.error("Có lỗi xảy ra khi tạo tài khoản");
    }
  };
